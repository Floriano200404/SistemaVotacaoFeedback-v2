...
public class RoundedPanelUtil extends JPanel {
    ...
    // Getter e Setter para o raio do canto
    ...
    // Getter e Setter para a cor de fundo
    ...
    protected void paintComponent(Graphics g) {
        ...
        graphics.fillRoundRect(0, 0, width - 1, height - 1, arcs.width, arcs.height); //pinta o fundo
        graphics.setColor(getForeground());
        // graphics.drawRoundRect(0, 0, width - 1, height - 1, arcs.width, arcs.height); //pinta a borda
    }
}
