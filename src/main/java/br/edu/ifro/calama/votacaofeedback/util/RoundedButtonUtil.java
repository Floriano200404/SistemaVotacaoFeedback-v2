...
public class RoundedButtonUtil extends JButton {
    ...
    public RoundedButtonUtil() {
        ...
        // Adiciona um listener para eventos do mouse para mudar as cores
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent me) {
                // A cor muda para a cor de clique quando pressionado
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Pinta o texto do botão por cima do fundo personalizado
